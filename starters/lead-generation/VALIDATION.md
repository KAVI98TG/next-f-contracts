...
```bash
node bin/nextf-contract.mjs validate starters/lead-generation/nextf.site.json --verbose
node bin/nextf-contract.mjs compatibility starters/lead-generation/nextf.site.json --json
```
