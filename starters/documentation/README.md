# Documentation Site Starter Contract Pack

**NEXT F Contracts:** 1.1.0
**Source reference:** examples.documentation-site  
**Site type:** documentation

Documentation and knowledge-base website with collections, articles, structured navigation, search, SEO, analytics and controlled downloads.
...
- 8 Modules
- 27 capabilities
- 203 contract references
- 2 API bindings
- 3 tracking observations
- 4 integration connectors
- 114 permission references
