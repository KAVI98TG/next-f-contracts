...
```bash
node bin/nextf-contract.mjs validate starters/corporate/nextf.site.json --verbose
node bin/nextf-contract.mjs compatibility starters/corporate/nextf.site.json --json
```
