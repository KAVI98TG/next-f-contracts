...
```bash
node bin/nextf-contract.mjs validate starters/service-business/nextf.site.json --verbose
node bin/nextf-contract.mjs compatibility starters/service-business/nextf.site.json --json
```
