...
```bash
node bin/nextf-contract.mjs validate starters/custom-extension/nextf.site.json --verbose
node bin/nextf-contract.mjs compatibility starters/custom-extension/nextf.site.json --json
```
