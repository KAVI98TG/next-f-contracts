...
```bash
node bin/nextf-contract.mjs validate starters/ecommerce/nextf.site.json --verbose
node bin/nextf-contract.mjs compatibility starters/ecommerce/nextf.site.json --json
```
